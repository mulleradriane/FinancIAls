      ...
      <CardHeader className="p-8 pb-0 flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
        <div>
          <div className="flex items-center gap-2">
            ...
            <InfoTooltip content="Compara o ritmo atual dos seus gastos com o mês passado no mesmo período. Ajuda a identificar se você está gastando mais ou menos do que o esperado para este ponto do mês." />
          </div>
